...
class TestAppData(unittest.TestCase):
    ...
    def test_initializeEmployeesSuccessful(self):
    ...
    def test_createTucksSuccessful(self):
    ...
    def test_findEmployeeByUsername_Successful(self):
    ...
    def test_createDeliveryPackage_successful(self):
    ...
    def test_findPackageByID_successful(self):
    ...
    def test_viewPackages_returnsCorrect(self):
    ...
    def test_getPackageLocations_returnsCorrect(self):
    ...
    def test_createDeliveryRoute_successful(self):
    ...
    def test_getRouteById_successful(self):
        self.mock_distance_calculator.calculate_total_distance.return_value = 500
        route = self.app_data.create_delivery_route((Locations.SYD.name, Locations.MEL.name), 'Aug 20 2024 17:20h')
        found_route = self.app_data.get_route_by_id(route.id)
        self.assertEqual(route, found_route)
    
    def test_findValidRoutesForPackage_returnsCorrect(self):
        self.mock_distance_calculator.calculate_total_distance.return_value = 500
    ...
    def test_assignPackageToRoute_returnsCorrect(self):
        self.mock_distance_calculator.calculate_total_distance.return_value = 500
    ...
    def test_assignTruckToRoute_successful(self):
    ...
    def test_findSuitableTruckByDistance_returnsCorrect(self):
